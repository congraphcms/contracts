...
namespace Congraph\Contracts\Workflows;

use Congraph\Contracts\Core\RepositoryContract;

/**
 * Interface for Workflow Point Repository class
 *
 ...
 * @version  	0.1.0-alpha
 */
interface WorkflowPointRepositoryContract extends RepositoryContract
{
